...
public class JwtService {
    private static final String SECRET_KEY = "ToiDaLamViecDuocNamPhutNenBayGioToiPhaiNghiNgoiThoiConMuaRoiBenHienHeVangDoiMinhChungDuongUoUoUo1214151316171819";
    public static final long JWT_TOKEN_VALIDITY = 1000L;
    private static final Logger logger = LoggerFactory.getLogger(com.codegym.service.jwt.JwtService.class.getName());
